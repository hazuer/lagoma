...
.wrapper {
  ...
  background-repeat: no-repeat;
    background-image: linear-gradient(rgb(83 162 195), rgb(22 64 80));
  position: absolute;
  /*top: 50%;*/
  left: 0;
  width: 100%;
...
<div class="container">
        <div class="card card-container">
            ...
            <img id="profile-img" class="profile-img-card" src="<?php echo base_url();?>assets/images/head_top_scop.png" />
