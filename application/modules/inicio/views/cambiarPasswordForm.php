...
<section id="content">
  <section class="vbox">
    <section class="scrollable padder">
      ...
      <div class="col-sm-12">
        <a href="<?php echo base_url();?>inicio" class="btn btn-s-md btn-info"><i class="fa fa-chevron-left"></i> Regresar</a>
      </div>
...
<script src="<?php echo base_url(); ?>assets/js/modules/configsys/cambiarPasswordForm.js"></script>